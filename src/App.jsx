...
// Using lazy loading for page components to reduce the initial bundle size.
// This improves Time to Interactive (TTI) by only loading the code needed for the current route.
        ...
        <AnimatePresence mode="wait">
            ...
            >
                {/*
                  ...
                  fallback={null} is used to avoid layout shifts during transitions,
                  allowing framer-motion to handle the entry animation once the component is ready.
                */}

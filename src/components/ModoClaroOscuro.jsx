...
export default function ToggleTema() {
    // Optimización Bolt: Inicialización perezosa (lazy initialization) del estado
    // Evita lecturas redundantes de localStorage y renders en cascada (cascading renders) al montar el componente.

...
export default function ToggleTema() {
    // Optimización: Inicialización perezosa (lazy initialization) para evitar re-renders innecesarios
    // y accesos repetitivos a localStorage en cada ciclo de renderizado.

...
// Optimización: Code-splitting por ruta para reducir el bundle inicial
    ...
    return (
        <AnimatePresence mode="wait">
            <Motion.div
                ...
                exit="salir"
            >
                <Suspense fallback={<div className="loading-fallback" style={{ height: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>Cargando...</div>}>

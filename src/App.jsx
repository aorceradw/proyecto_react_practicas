...
// Lazy loading components for performance (route-based code splitting)
    ...
    return (
        <AnimatePresence mode="wait">
            <motion.div
                ...
                exit="salir"
            >
                {/* Suspense allows us to show a fallback while the lazy-loaded components are being fetched */}
